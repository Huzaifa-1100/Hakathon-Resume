    ...
    editButton.addEventListener("click", function () {
        ...
        editableSections.forEach(function (sectionId) {
            ...
            if (isEditMode) {
                ...
                switch (sectionId) {
                    case "editableName":
                        document.getElementById("name").value = updatedValue;
                        break;
                    case "editableEmail":
                        document.getElementById("email").value = updatedValue;
                        break;
                    case "editablePhone":
                        document.getElementById("phone").value = updatedValue;
                        break;
                    case "editableEducation":
                        document.getElementById("education").value = updatedValue;
                        break;
                    case "editableExperience":
                        document.getElementById("experience").value = updatedValue;
                        break;
                    case "editableSkills":
                        document.getElementById("skills").value = updatedValue;
                        break;
                }
            }
            else {
